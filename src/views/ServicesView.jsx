...
const services = [
    {
        ...
        image: `${import.meta.env.BASE_URL}Bordado.webp`,
        color: '#0057B8',
    },
    {
        id: 'dtf',
        ...
        image: `${import.meta.env.BASE_URL}DTF (Direct to Film).webp`,
        color: '#0A1628',
    },
    {
        id: 'serigrafia',
...
const ServicesView = ({ navigate }) => (
    <div className="flex-1 bg-white">
        {/* Hero */}
        <div className="relative bg-[#0A1628] text-white py-16 md:py-28 overflow-hidden">
            <img src={`${import.meta.env.BASE_URL}Servicio de Decorado.webp`} alt="Servicios de decorado" className="absolute inset-0 w-full h-full object-cover opacity-40" />
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
                    ...
                    <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-4 tracking-tight">Servicios de Decorado</h1>
