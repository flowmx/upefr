...
// Fix bug #3: imagen de fondo usa hero-slider-1.webp existente + BASE_URL
const LoginView = ({ goHome, setIsAuthenticated }) => {
    ...
    return (
        ...
        >
            ...
            <img src={`${import.meta.env.BASE_URL}hero-slider-1.webp`} alt="Background" className="absolute inset-0 w-full h-full object-cover z-0 grayscale" />
